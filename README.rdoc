...
=== Hosts Compute Extension:
  # Get info on all hosts:
  >> os.hosts
  => [#<OpenStack::Compute::Host:0x9bed5a8 @host_name="svr.name.com", @service="compute", @zone=nil>, #<OpenStack::Compute::Host:0x9bed4e0 @host_name="svr.name.com", @service="cert", @zone=nil>, #<OpenStack::Compute::Host:0x9bed418 @host_name="svr.name.com", @service="consoleauth", @zone=nil>, #<OpenStack::Compute::Host:0x9bed33c @host_name="svr.name.com", @service="scheduler", @zone=nil>, #<OpenStack::Compute::Host:0x9bed2d8 @host_name="svr.name.com", @service="network", @zone=nil>, #<OpenStack::Compute::Host:0x9bed1e8 @host_name="svr.name.com", @service="console", @zone=nil>, #<OpenStack::Compute::Host:0x9bed10c @host_name="svr.name.com", @service="volume", @zone=nil>]

  # Get details for a specific host:
  >> os.host_details("svr.name.com")
  => [{:cpu=>1, :disk_gb=> 1024, :host => 123, :memory_mb =>1, :project=>"foo"}, {:cpu=>2, :disk_gb=> 1024, :host => 123, :memory_mb =>2, :project=>"bar" }]

  >> os.manage_host(host_name, {:status => "enable", :maintenance_mode=>"disable"})
  >> os.shutdown_host(host_name)
  >> os.reboot_host(host_name)
